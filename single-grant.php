...
$related_grant_ids = !empty($scored_related_grants) ? wp_list_pluck($scored_related_grants, 'id') : array();
        ...
        <article class="gus-main">
            ...
            <section id="related" class="gus-related-section">
                ...
                <div class="gus-related-grid">
                    ...
                    while ($related_query->have_posts() && $related_count < $display_limit) : 
                        $related_query->the_post();
                        $related_count++;
                        
                        // Use the reusable card template
                        get_template_part('template-parts/grant/card');
                    endwhile; ?>
                </div>
                
                <?php if ($related_query->post_count > $display_limit): ?>
